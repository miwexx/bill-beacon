    ...
    <div class="main-content fade-in">
      <div class="content-pad">
        <div class="card card-pad">
          <div class="month-nav">
            <button class="month-nav-btn" onclick="navigate('calendar', {month: '${prevMonth}'})">${svgIcon('chevronLeft', 22)}</button>
            <div class="month-nav-title">${formatDate(viewDate.toISOString(), 'monthYear')}</div>
            <button class="month-nav-btn" onclick="navigate('calendar', {month: '${nextMonth}'})">${svgIcon('chevronRight', 22)}</button>
          </div>
      ...
      ${monthBillsSorted.length > 0 ? `
        <div>
          <div class="section-header">Bills This Month</div>
          <div class="card">
        ...
        <div class="settings-section">
          ...
          <div class="card">
            <div class="form-row">
              ...
              <div style="flex:1;color:var(--text-muted)">${billCount} bill${billCount === 1 ? '' : 's'} stored on device</div>
            </div>
          ...
          <div class="settings-footer">All data is stored on this device only. No cloud, no sync, no account.</div>
        </div>

        <div class="settings-section">
          <div class="section-header">About</div>
          <div class="card">
            <div class="about-row"><span class="about-label">App Name</span><span class="about-value">Bill Beacon</span></div>
            <div class="about-row"><span class="about-label">Version</span><span class="about-value">1.0.0</span></div>
            <div class="about-row"><span class="about-label">Storage</span><span class="about-value">Local (Offline)</span></div>
            <div class="about-row"><span class="about-label">Cost</span><span class="about-value text-paid">Free</span></div>
            <div class="about-row"><span class="about-label">Ads</span><span class="about-value">None</span></div>
            <div class="about-row"><span class="about-label">Account</span><span class="about-value">Not Required</span></div>
          </div>
        </div>
